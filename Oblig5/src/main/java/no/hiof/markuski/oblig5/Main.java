...
//        solar.addPlanet(new Car("Saturn", 0.8145247020645666, 0.2994204425711275, 9.5826, 0.057, 10585, sun, "http://bit.ly/2W0sqic"));
//        solar.addPlanet(new Car("Venus", 0.08465003077267387, 0.002564278187565859, 0.723, 0.007, 225, sun, "http://bit.ly/2W3p4L9"));
//        solar.addPlanet(new Car("Jupiter", 1.0, 1.0, 5.20440, 0.049, 4380, sun, "http://bit.ly/2Q0fjK3"));
//        solar.addPlanet(new Car("Earth", 0.08911486599899289, 0.003146469968387777, 1, 0.017, 365, sun, "http://bit.ly/33bvXLZ"));
//        solar.addPlanet(new Car("Uranus", 0.35475297935433336, 1, 19.2184, 0.046, 30660, sun, "http://bit.ly/335pbHy"));
//        solar.addPlanet(new Car("Mercury", 0.03412549655905556, 1.7297154899894627E-4, 0.387, 0.206, 88, sun, "http://bit.ly/2TB2Heo"));
//        solar.addPlanet(new Car("Mars", 0.04741089912158004, 3.3667017913593256E-4, 1.524, 0.093, 687, sun, "http://bit.ly/3aGyFvr"));
//        solar.addPlanet(new Car("Neptune", 0.34440217087226543, 0.05395152792413066, 30.11, 0.010, 60225, sun, "http://bit.ly/38AyEba\n"));
//        ArrayList<Car> carListForMilkyWay = solar.getPlanets();
//        planetSystems.add(solar);
//
//
//        //Planets for Kepler
//        kepler.addPlanet(new Car("Kepler-11b", 0.1610, 0.0060, 1.36134E7, 0.045, 10.0, kepler11, "x"));
//        kepler.addPlanet(new Car("Kepler-11c", 3.15, 13.5, 1.5857E7, 0.026, 13.0, kepler11, "x"));
//        kepler.addPlanet(new Car("Kepler-11d", 3.43, 6.1, 2.3786E7, 0.004, 22.0, kepler11, "x"));
//        kepler.addPlanet(new Car("Kepler-11e", 4.52, 8.4, 2.9021E7, 0.012, 31.0, kepler11, "x"));
//        kepler.addPlanet(new Car("Kepler-11f", 2.61, 2.3, 3.7399E7, 0.013, 36.0, kepler11, "x"));
//        kepler.addPlanet(new Car("Kepler-11g", 3.66, 25, 6.9114E7, 0.015, 118.0, kepler11, "x"));
//        ArrayList<Car> carListForKepler = kepler.getPlanets();
...
//            for (Car aCar : aSystem.getPlanets()) {
...
//                        ";" + aSystem.getCenterStar().getEffectiveTemp() + ";" + aCar.getName() + ";" + aCar.getRadius() +
//                        ";" + aCar.getMass() + ";" + aCar.getSemiMajorAxis() + ";" + aCar.getEccentricity() +
//                        ";" + aCar.getOrbitalPeriod() + ";" + aCar.getCentralCelestialBody() + ";" + aCar.getPictureUrl());
//            }
//            writer.newLine();
//        }
//    }
